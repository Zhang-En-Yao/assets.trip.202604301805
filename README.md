# assets.trip.202604301805

Okinawa, April–May 2026 — everything the trip's page on
...
```
https://cdn.jsdelivr.net/gh/Zhang-En-Yao/assets.trip.202604301805@<tag>/content.json
```
...
The 45 photographs are in `photos/`, referenced by file name from `content.json`.
